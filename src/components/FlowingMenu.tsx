...
const MenuItem: React.FC<MenuItemProps> = ({
  ...
  return (
    <div
      className="flex-shrink-0 relative overflow-hidden text-center"
      ref={itemRef}
      style={{ borderTop: isFirst ? 'none' : `1px solid ${borderColor}` }}
    >
      <a
        className="flex items-center justify-center py-4 relative cursor-pointer uppercase no-underline font-semibold text-[4vh]"
        href={link}
